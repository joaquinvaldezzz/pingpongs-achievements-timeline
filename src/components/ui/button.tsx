...
const buttonStyles = tv({
  base: [
    ...
    "bg-(--btn-bg) text-(--btn-fg) ring-(--btn-ring) outline-(--btn-outline) hover:bg-(--btn-overlay) pressed:bg-(--btn-overlay)",
    "relative isolate inline-flex items-center justify-center font-medium inset-ring inset-ring-fg/15",
    ...
    "*:data-[slot=icon]:-mx-0.5 *:data-[slot=icon]:my-0 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:self-center *:data-[slot=icon]:text-(--btn-icon) hover:*:data-[slot=icon]:text-(--btn-icon-active)/90 focus-visible:*:data-[slot=icon]:text-(--btn-icon-active)/80 sm:*:data-[slot=icon]:my-0 forced-colors:[--btn-icon:ButtonText] forced-colors:hover:[--btn-icon:ButtonText] pressed:*:data-[slot=icon]:text-(--btn-icon-active)",
...
function Button({ className, intent, size, isCircle, ref = undefined, ...props }: ButtonProps) {
  return (
    <ButtonPrimitive
