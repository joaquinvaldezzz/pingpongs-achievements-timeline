...
export function Input({ className, ref = undefined, ...props }: InputProps) {
  return (
    <span className="relative block w-full" data-slot="control">
      <InputPrimitive
        className={cx(
          ...
          "focus:border-ring/70 focus:bg-(--input-focus-bg) focus:ring-3 focus:ring-ring/20 focus:outline-hidden focus:enabled:hover:border-ring/80",
  ...
  return (
    <Group
      className={cx(
        ...
        "*:[button]:absolute *:[button]:top-0 *:[button]:z-10 *:[button]:min-h-11 sm:*:[button]:min-h-9 [&>button[data-intent=outline]]:border-input",
